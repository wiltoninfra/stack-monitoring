 ...
 */
class P2PTransactionStatusChangeListener extends Command
{
    /**
    ...
    protected $signature = 'promo:p2p-transactions-listener';

    protected $queue_name = 'promo/core/p2p-transaction-status-change';
    ...
    public function __invoke(array $data)
    {
        ...
        {
            $consumer_id = (int) $data['Transaction']['consumer_id_payer'];
            $id = (int) $data['Transaction']['id'];

            try
            {
                $this->cashback_service->undoCashback($consumer_id, TransactionTypeEnum::P2P, $id);
            }
